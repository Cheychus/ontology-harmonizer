    ...
    <div class="py-4 flex flex-col gap-2">
        ...
        <div class="grid grid-cols-4 gap-4">
            {#each term.xrefs as reference, index}
                <div class="flex flex-col justify-center p-2 border-gray-100 border">
                    <div class="flex gap-2 items-center">
                        <p>{reference}</p>
                        <Button variant={"outline"} onclick={() => oboFileStore.removeXref(term, index)} class="ml-auto"
                            ><svg
    ...
    <div class="py-4 flex flex-col gap-2">
        ...
        <div class="grid grid-cols-4 gap-4">
            {#each term.synonyms as synonym, index}
                <div class="flex flex-col justify-center p-2 border-gray-100 border">
                    <div class="flex gap-2 items-center">
                        <p>{synonym.synonymText}</p>
                        <Button onclick={() => oboFileStore.removeSynonym(term, index)} variant={"outline"} class="ml-auto"
                            ><svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
