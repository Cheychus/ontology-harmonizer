<script lang="ts">
    import { downloadObo, parseOntologyFile } from "$lib/services/oboFiles/oboFile.service";
    import { oboFileStore, OboFileStore } from "$lib/stores/oboFiles/OboFileStore.svelte";
    import { ChevronRight, ChevronsDown, Download, Upload } from "lucide-svelte";
